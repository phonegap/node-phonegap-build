...
module.exports = function(options, callback) {
    ...
    var paths = {
        www: path.join(options.path, 'www'),
        build: path.join(options.path, 'build')
    };

    // compress app for upload
    zip.compress(paths.www, paths.build, function(e, zipPath) {
        if (e) {
            callback(e);
            return;
        }
        ...
        options.api.post('/apps', headers, function(e, response) {
            ...
            // @TODO this cannot be a permanent solution.
