...
function authenticate(options, data, callback) {
    client.auth(options, function(e, api) {
        ...
        config.global.save(data, function(e) {
            ...
            // complete
            console.log('log', 'logged in as', options.username);
            callback(null, api);
        });
    });
}
...
console.log(options);
            ...
            if (options.username && options.password) {
                authenticate(options, data, callback);
            }
            // authenticate after retrieving missing username and/or password
            // with the current foc, this block should never be reached
            else {
